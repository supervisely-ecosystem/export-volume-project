...
from supervisely_lib.geometry.constants import (ANY_SHAPE, CLASS_ID,
                                                CREATED_AT, ID, LABELER_LOGIN,
                                                UPDATED_AT)
...
geometries_map._JSON_SHAPE_TO_GEOMETRY_TYPE[
    ClosedSurfaceMesh.geometry_name()
] = ClosedSurfaceMesh
